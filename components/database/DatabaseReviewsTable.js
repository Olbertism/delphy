...
export default function ReviewsTable(props) {
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - props.reviews.length) : 0;
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={props.reviews.length}
            />
            <TableBody>
              {/* if you don't need to support IE11, you can replace the `stableSort` call with:
                 rows.slice().sort(getComparator(order, orderBy)) */}
              {stableSort(props.reviews, getComparator(order, orderBy))
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Link href={`/database/reviews/${review.reviewId}`}>
                          {review.reviewTitle}
                        </Link>
                      </TableCell>
                      <TableCell align="right">
